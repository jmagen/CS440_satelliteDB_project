...
transactions = 0
satellitecount = 0
jsonfilename = os.path.join(os.path.dirname(__file__) + "\\..\\JSON", 'n2yo_satellite_tle_data.json') 
with open(jsonfilename, 'w') as outfile:
	while satellitecount <= 200: # get satellite id, name, and tle for first 200 satellites
